...
Future<void> sendCustomEmailForValorProds(String recipientEmail,
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; margin: 30px auto; background-color: white; border-radius: 8px; overflow: hidden;">
      <tr>
        <td style="padding: 25px;">
          ...
          <p style="margin: 0 0 16px 0;">Se ha registrado el pago de productos selectos adeudados en la tienda: <strong>$nombreTienda</strong>.</p>

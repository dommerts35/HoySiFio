...
Future<void> sendCustomEmailForClienteLogin(
  ...
  <title>Inicio de sesión detectado - HoySíFio</title>
  </head>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #286181;">
      <tr>
        <td align="center" style="padding: 20px;">
          ...
          <h1 style="color: white; margin: 10px 0 0 0;">Notificación de seguridad</h1>
        </td>
      </tr>
    </table>

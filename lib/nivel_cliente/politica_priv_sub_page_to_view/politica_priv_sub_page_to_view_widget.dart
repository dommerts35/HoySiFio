...
import 'politica_priv_sub_page_to_view_model.dart';
export 'politica_priv_sub_page_to_view_model.dart';

class PoliticaPrivSubPageToViewWidget extends StatefulWidget {
  const PoliticaPrivSubPageToViewWidget({
    super.key,
    this.cedula,
    this.nombreCliente,
    this.idTenderosList,
  ...
  static String routeName = 'politicaPrivSubPageToView';
  static String routePath = '/politicaPrivSubPageToView';

  @override
  State<PoliticaPrivSubPageToViewWidget> createState() =>
      _PoliticaPrivSubPageToViewWidgetState();
}

class _PoliticaPrivSubPageToViewWidgetState
    extends State<PoliticaPrivSubPageToViewWidget>
    with TickerProviderStateMixin {
  late PoliticaPrivSubPageToViewModel _model;

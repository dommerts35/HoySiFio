...
import 'terms_of_service_login_model.dart';
export 'terms_of_service_login_model.dart';

class TermsOfServiceLoginWidget extends StatefulWidget {
  const TermsOfServiceLoginWidget({super.key});

  static String routeName = 'termsOfServiceLogin';
  static String routePath = '/termsOfServiceLogin';

  @override
  State<TermsOfServiceLoginWidget> createState() =>
      _TermsOfServiceLoginWidgetState();
}

class _TermsOfServiceLoginWidgetState extends State<TermsOfServiceLoginWidget> {
  late TermsOfServiceLoginModel _model;

...
class PagoFinalWidget extends StatefulWidget {
  ...
  static String routeName = 'pagoFinal';
  static String routePath = '/pagoFinal';
                                ...
                                child: Padding(
                                  ...
                                  child: Material(
                                    ...
                                    child: Theme(
                                      ...
                                      child: CheckboxListTile(
                                        value: _model.paypalCheckValue ??=
                                            false,
                                        onChanged: (newValue) async {
                                          safeSetState(() => _model
                                              .paypalCheckValue = newValue!);
                                        },
                                        title: Text(
                                          FFLocalizations.of(context).getText(
                                            'a10gdgfw' /* Paypal */,
                                ...
                                child: Padding(
                                  ...
                                  child: Material(
                                    ...
                                    child: Theme(
                                      ...
                                      child: CheckboxListTile(
                                        value: _model.cardCheckValue ??= false,
                                        onChanged: (newValue) async {
                                          safeSetState(() => _model
                                              .cardCheckValue = newValue!);
                                        },
                                        title: Text(
                                          FFLocalizations.of(context).getText(
                                            '59ym2gmf' /* Tarjeta */,
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (_model.paypalCheckValue ?? true)
                        FFButtonWidget(
                          onPressed: () {
                            print('Button pressed ...');
                          },
                          text: FFLocalizations.of(context).getText(
                            'z7i5v0i2' /* Pay w/Paypal */,
                          ),
                          icon: FaIcon(

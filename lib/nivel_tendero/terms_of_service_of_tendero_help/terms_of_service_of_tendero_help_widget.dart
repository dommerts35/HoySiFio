...
import 'terms_of_service_of_tendero_help_model.dart';
export 'terms_of_service_of_tendero_help_model.dart';

class TermsOfServiceOfTenderoHelpWidget extends StatefulWidget {
  const TermsOfServiceOfTenderoHelpWidget({
    super.key,
    this.tenderoRef,
    this.nombreTienda,
    this.tenderoEmail,
  ...
  static String routeName = 'termsOfServiceOfTenderoHelp';
  static String routePath = '/termsOfServiceOfTenderoHelp';

  @override
  State<TermsOfServiceOfTenderoHelpWidget> createState() =>
      _TermsOfServiceOfTenderoHelpWidgetState();
}

class _TermsOfServiceOfTenderoHelpWidgetState
    extends State<TermsOfServiceOfTenderoHelpWidget> {
  late TermsOfServiceOfTenderoHelpModel _model;

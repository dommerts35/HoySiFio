...
import 'politica_priv_of_tendero_help_model.dart';
export 'politica_priv_of_tendero_help_model.dart';

class PoliticaPrivOfTenderoHelpWidget extends StatefulWidget {
  const PoliticaPrivOfTenderoHelpWidget({
    super.key,
    this.tenderoRef,
    this.nombreTienda,
    this.tenderoEmail,
  ...
  static String routeName = 'politicaPrivOfTenderoHelp';
  static String routePath = '/politicaPrivOfTenderoHelp';

  @override
  State<PoliticaPrivOfTenderoHelpWidget> createState() =>
      _PoliticaPrivOfTenderoHelpWidgetState();
}

class _PoliticaPrivOfTenderoHelpWidgetState
    extends State<PoliticaPrivOfTenderoHelpWidget>
    with TickerProviderStateMixin {
  late PoliticaPrivOfTenderoHelpModel _model;

...
import 'cliente_prod_valor_pago_first_model.dart';
export 'cliente_prod_valor_pago_first_model.dart';

class ClienteProdValorPagoFirstWidget extends StatefulWidget {
  const ClienteProdValorPagoFirstWidget({
    super.key,
    required this.idCliente,
    required this.passedDTProd,
    this.lastSumTotalPagoToVPF,
  });

  /// idCliente
  final DocumentReference? idCliente;

  final List<DataTypeProductosStruct>? passedDTProd;
  final double? lastSumTotalPagoToVPF;

  static String routeName = 'clienteProd-ValorPagoFirst';
  static String routePath = '/clienteProdValorPagoFirst';

  @override
  State<ClienteProdValorPagoFirstWidget> createState() =>
      _ClienteProdValorPagoFirstWidgetState();
}

class _ClienteProdValorPagoFirstWidgetState
    extends State<ClienteProdValorPagoFirstWidget> {
  late ClienteProdValorPagoFirstModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClienteProdValorPagoFirstModel());
                  ...
                  children: [
                    StreamBuilder<ClientesRecord>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        return Text(
                          'Total: \$${widget.lastSumTotalPagoToVPF?.toString()}',

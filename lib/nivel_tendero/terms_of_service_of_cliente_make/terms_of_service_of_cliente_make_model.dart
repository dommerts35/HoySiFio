...
import '/index.dart';
import 'terms_of_service_of_cliente_make_widget.dart'
    show TermsOfServiceOfClienteMakeWidget;
import 'package:flutter/material.dart';

class TermsOfServiceOfClienteMakeModel
    extends FlutterFlowModel<TermsOfServiceOfClienteMakeWidget> {
  ...
  // Stores action output result for [Custom Action - checkInternetConnection] action in termsOfServiceOfClienteMake widget.
  bool? isInternetGood;

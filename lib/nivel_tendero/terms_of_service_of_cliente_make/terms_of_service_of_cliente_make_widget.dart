...
import 'terms_of_service_of_cliente_make_model.dart';
export 'terms_of_service_of_cliente_make_model.dart';

class TermsOfServiceOfClienteMakeWidget extends StatefulWidget {
  const TermsOfServiceOfClienteMakeWidget({
    super.key,
    this.tenderoRef,
    this.nombreTienda,
    this.tenderoEmail,
  ...
  static String routeName = 'termsOfServiceOfClienteMake';
  static String routePath = '/termsOfServiceOfClienteMake';

  @override
  State<TermsOfServiceOfClienteMakeWidget> createState() =>
      _TermsOfServiceOfClienteMakeWidgetState();
}

class _TermsOfServiceOfClienteMakeWidgetState
    extends State<TermsOfServiceOfClienteMakeWidget> {
  late TermsOfServiceOfClienteMakeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TermsOfServiceOfClienteMakeModel());
                                                ...
                                                child: RichText(
                                                  ...
                                                  text: TextSpan(
                                                    children: [
                                                      ...
                                                      TextSpan(
                                                        text:
                                                            '\n\nHOYSIFIO no será responsable por los daños o perjuicios directos o indirectos que se produzcan por el uso inadecuado, incorrecto o desprolijo de parte del USUARIO de HOYSIFIO o información errónea ingresada. \n\nEl USUARIO tiene la obligación de verificar los números de cuenta, montos y demás información necesaria para realizar las transacciones.\n\nHOYSIFIO no es responsable por la incompatibilidad con el software del dispositivo móvil desde el cual el USUARIO accede a HOYSIFIO.\n\nEL USUARIO es responsable de todas las interacciones realizadas en HOYSIFIO; así como, de la información ingresada para guardar transacciones. \n\nHOYSIFIO no está obligado a tomar medidas posteriores para confirmar o autenticar tales instrucciones y tomará acción sobre ellas tan pronto las reciba, sin necesidad de confirmación posterior.\n\nHOYSIFIO no será responsable por deficiencias en el grado de exactitud, de la totalidad, de la disponibilidad o de la conveniencia de dicha información.\n\nSalvo que la ley exija lo contrario, de ninguna manera HOYSIFIO es legalmente responsable ante el USUARIO por concepto de daños especiales, indirectos o consecuentes derivados del uso de HOYSIFIO de parte del USUARIO.\n\nHOYSIFIO no asume ni podrá adjudicársele responsabilidad alguna, por daños causados por programas maliciosos que puedan perjudicar en el equipo, dispositivo o alguna otra propiedad del USUARIO en relación con su acceso a HOYSIFIO.\n',
                                                        style:
                                                            GoogleFonts.ptSerif(
                                                          fontSize: 17.0,
                                                        ),
                                                      ...
                                                      TextSpan(
                                                        text:
                                                            '\n\nEl USUARIO declara que tiene capacidad legal para aceptar y obligarse con este instrumento, por lo que exime de toda responsabilidad a HOYSIFIO en caso de que estas declaraciones sean falsas, inexactas o no se ajusten totalmente a la verdad.',
                                                        style:
                                                            GoogleFonts.ptSerif(
                                                          fontWeight:
                                                              FontWeight.w500,
                                                      ...
                                                      TextSpan(
                                                        text:
                                                            '\n\nEL USUARIO declara que los fondos objeto de la(s) transacción(es) registradas en HOYSIFIO, no provienen de/ni serán destinados a ninguna actividad ilegal o delictiva. Declara adicionalmente que no tiene relación alguna con el lavado de activos, financiamiento del terrorismo y otros delitos y más infracciones previstas en la\n \nLey Orgánica de Prevención, Detección y Erradicación del Delito de Lavado de Activos y del Financiamiento de Delitos y en la normativa vigente.\n\nEl USUARIO expresamente autoriza a HOYSIFIO a realizar las verificaciones y debida diligencia correspondientes e informar de manera inmediata y documentada a la(s) autoridad(es) competente(s) en casos de investigación o cuando se detecten transacciones inusuales e injustificadas, por lo que El USUARIO no ejercerá ningún reclamo o acción judicial.\n',
                                                        style:
                                                            GoogleFonts.ptSerif(
                                                          fontSize: 17.0,
                                                        ),
                                                      ...
                                                      TextSpan(
                                                        text:
                                                            '\n\nPara el caso de juicio por cualquier causa, entre otras, el USUARIO hace una renuncia general de domicilio y queda sometido a los jueces o tribunales del lugar donde se encuentre o a los de la ciudad de su domicilio o a los de la ciudad de Quito, a elección del HOYSIFIO y al procedimiento que por Ley corresponda.',
                                                        style:
                                                            GoogleFonts.ptSerif(
                                                          fontSize: 17.0,
                                                        ),

...
class _TenderoEditInfoWidgetState extends State<TenderoEditInfoWidget>
  ...
  void initState() {
    ...
    _model.mailEditFocusNode!.addListener(() => safeSetState(() {}));
                                                                      ...
                                                                      onChanged:
                                                                        ...
                                                                        if (newValue!) {
                                                                          if (_model.betterCheckCASecValue ==
                                                                              true) {
                                                                            safeSetState(() {
                                                                              _model.betterCheckCCSecValue = true;
                                                                            });
                                                                            safeSetState(() {
                                                                              _model.betterCheckCASecValue = false;
                                                                            });
                                                                          } else {
                                                                            safeSetState(() {
                                                                              _model.betterCheckCCSecValue = true;
                                                                      ...
                                                                      onChanged:
                                                                        ...
                                                                        if (newValue!) {
                                                                          if (_model.betterCheckCCSecValue ==
                                                                              true) {
                                                                            safeSetState(() {
                                                                              _model.betterCheckCASecValue = true;
                                                                            });
                                                                            safeSetState(() {
                                                                              _model.betterCheckCCSecValue = false;
                                                                            });
                                                                          } else {
                                                                            safeSetState(() {
                                                                              _model.betterCheckCASecValue = true;

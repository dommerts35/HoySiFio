...
import '/index.dart';
import 'tendero_ayuda_widget.dart' show TenderoAyudaWidget;
import 'package:flutter/material.dart';

class TenderoAyudaModel extends FlutterFlowModel<TenderoAyudaWidget> {
  ...
  // Stores action output result for [Custom Action - checkInternetConnection] action in tenderoAyuda widget.
  bool? isInternetGood;

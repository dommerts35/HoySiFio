                                                                      ...
                                                                      if (((_model.cantidatTfTextController.text != '') &&
                                                                        ...
                                                                        if ((widget.viviendaProp ==
                                                                          ...
                                                                          if ((widget.viviendaAlq == true) &&
                                                                            ...
                                                                            if (clienteInfoEditClientesRecord.cliente.customLimit >
                                                                                0) {
                                                                        ...
                                                                        safeSetState(
                                                                            () {});
                                                                        if ((_model.queryOnAnadirNonCalc?.cliente.producto != null &&
                                                                                (_model.queryOnAnadirNonCalc?.cliente.producto)!.isNotEmpty) ==
                                                                            true) {
                                                                          while (_model.tempCount <
                                                                              _model.queryOnAnadirNonCalc!.cliente.producto.length) {
                                                                            _model.tempSumProductos =
                                                                                _model.tempSumProductos + _model.queryOnAnadirNonCalc!.cliente.producto.elementAtOrNull(_model.tempCount)!.valorProd;
                                                                            safeSetState(() {});
                                                                            _model.tempCount =
                                                                                _model.tempCount + 1;
                                                                            safeSetState(() {});
                                                                        ...
                                                                        safeSetState(
                                                                            () {});
                                                                        if ((_model.queryOnAnadirNonCalc?.cliente.historialPorPagarProd != null &&
                                                                                (_model.queryOnAnadirNonCalc?.cliente.historialPorPagarProd)!.isNotEmpty) ==
                                                                            true) {
                                                                          while (_model.tempCount <
                                                                              _model.queryOnAnadirNonCalc!.cliente.historialPorPagarProd.length) {
                                                                            _model.tempSumHistorial =
                                                                                _model.tempSumHistorial + _model.queryOnAnadirNonCalc!.cliente.historialPorPagarProd.elementAtOrNull(_model.tempCount)!.totalPorPagar;
                                                                            safeSetState(() {});
                                                                            _model.tempCount =
                                                                                _model.tempCount + 1;
                                                                            safeSetState(() {});

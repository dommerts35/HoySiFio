                                                                  ...
                                                                  await showDialog(
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return AlertDialog(
                                                                        ...
                                                                        content:
                                                                            Text('Su cliente aun le adeuda cuentas'),
                                                                        actions: [
                                                                          TextButton(
                                                                            onPressed: () =>
                                                                  ...
                                                                  await showDialog(
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return AlertDialog(
                                                                        ...
                                                                        content:
                                                                            Text('El cliente aún tiene deudas pendientes'),
                                                                        actions: [
                                                                          TextButton(
                                                                            onPressed: () =>
                                                                                Navigator.pop(alertDialogContext),
                                                        ...
                                                        children: [
                                                          if ((_model
                                                            ...
                                                            FFButtonWidget(
                                                              onPressed:
                                                                  () async {
                                                                _model.queryHistorialPorCobrarAlFio =
                                                                    await queryClientesRecordOnce(
                                                                  queryBuilder: (clientesRecord) =>
                                                                      clientesRecord
                                                                          .where(
                                                          ...
                                                          if ((_model
                                                            ...
                                                            FFButtonWidget(
                                                              onPressed:
                                                                  () async {
                                                                _model.queryHistorialPorCobrarCobrar =
                                                                    await queryClientesRecordOnce(
                                                                  queryBuilder: (clientesRecord) =>
                                                                      clientesRecord
                                                                          .where(
                                                          ...
                                                          if ((_model
                                                            ...
                                                            FFButtonWidget(
                                                              onPressed:
                                                                  () async {
                                                                _model.queryHistorialPorCobrarAbonar =
                                                                    await queryClientesRecordOnce(
                                                                  queryBuilder: (clientesRecord) =>
                                                                      clientesRecord
                                                                          .where(

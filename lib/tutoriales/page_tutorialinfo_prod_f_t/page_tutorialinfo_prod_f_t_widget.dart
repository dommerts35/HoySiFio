...
import 'page_tutorialinfo_prod_f_t_model.dart';
export 'page_tutorialinfo_prod_f_t_model.dart';

class PageTutorialinfoProdFTWidget extends StatefulWidget {
  const PageTutorialinfoProdFTWidget({
    super.key,
    this.tenderoRef,
    this.nombreCliente,
    this.telf,
  ...
  static String routeName = 'pageTutorialinfoProdFT';
  static String routePath = '/pageTutorialinfoProdFT';

  @override
  State<PageTutorialinfoProdFTWidget> createState() =>
      _PageTutorialinfoProdFTWidgetState();
}

class _PageTutorialinfoProdFTWidgetState
    extends State<PageTutorialinfoProdFTWidget> {
  late PageTutorialinfoProdFTModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PageTutorialinfoProdFTModel());
                                ...
                                child: SingleChildScrollView(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        'Esta pantalla centraliza toda la información y gestión del cliente: datos personales, historial de compras y productos fiados. Si desea saltar este tutorial, toque el botón \"Saltar\" en la parte inferior derecha. Desliza a la derecha para continuar.',
                                        textAlign: TextAlign.center,
                                        style: FlutterFlowTheme.of(context)
                                            .bodyLarge
                                            .override(

...
import 'page_tutorial_lista_clientes_model.dart';
export 'page_tutorial_lista_clientes_model.dart';

class PageTutorialListaClientesWidget extends StatefulWidget {
  const PageTutorialListaClientesWidget({
    super.key,
    this.tenderoRef,
    String? nombreTienda,
    this.tenderoEmail,
  ...
  static String routeName = 'pageTutorialListaClientes';
  static String routePath = '/pageTutorialListaClientes';

  @override
  State<PageTutorialListaClientesWidget> createState() =>
      _PageTutorialListaClientesWidgetState();
}

class _PageTutorialListaClientesWidgetState
    extends State<PageTutorialListaClientesWidget> {
  late PageTutorialListaClientesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PageTutorialListaClientesModel());

...
import 'page_tutorial_lista_clientes_from_help_model.dart';
export 'page_tutorial_lista_clientes_from_help_model.dart';

class PageTutorialListaClientesFromHelpWidget extends StatefulWidget {
  const PageTutorialListaClientesFromHelpWidget({
    super.key,
    this.tenderoRef,
    String? nombreTienda,
    this.tenderoEmail,
  ...
  static String routeName = 'pageTutorialListaClientesFromHelp';
  static String routePath = '/pageTutorialListaClientesFromHelp';

  @override
  State<PageTutorialListaClientesFromHelpWidget> createState() =>
      _PageTutorialListaClientesFromHelpWidgetState();
}

class _PageTutorialListaClientesFromHelpWidgetState
    extends State<PageTutorialListaClientesFromHelpWidget>
    with TickerProviderStateMixin {
  late PageTutorialListaClientesFromHelpModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => PageTutorialListaClientesFromHelpModel());
                                  ...
                                  child: SingleChildScrollView(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          '¡Bienvenido a esta guía rápida! 🚀 \nPara omitir este tutorial, haz clic en el botón \"Saltar\" en la parte inferior derecha. Desliza a la derecha para continuar.',
                                          textAlign: TextAlign.center,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyLarge
                                              .override(
                                  ...
                                  child: SingleChildScrollView(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'En esta sección verás la lista de los clientes que registres en tu tienda. Al comenzar, la lista estará vacía.',
                                          textAlign: TextAlign.center,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyLarge
                                              .override(

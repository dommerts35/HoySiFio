...
DocumentReference? get currentUserReference =>
    loggedIn ? TenderosRecord.collection.doc(currentUser!.uid) : null;

TenderosRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : TenderosRecord.getDocument(TenderosRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
